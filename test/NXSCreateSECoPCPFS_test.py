...
class NXSCreateSECoPCPFSTest(unittest.TestCase):
    ...
    def __init__(self, methodName):
        ...
        self.myuni = (
            ...
            '      <field name="type" type="NX_CHAR">sample'
            ...
            '[sim] uniaxial pressure device<strategy mode="INIT"/></field>\n'
            ...
            '<attribute name="secop_function" type="NX_CHAR">rotation_z'
            '</attribute></field>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv_pollinterval_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            ...
            '$datasources.{cpname}_drv_target<strategy mode="INIT"/></field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv_target_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__interval_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__speed_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__safe_current_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__move_limit_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__maxcurrent_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__tolerance_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '          </group>\n'
            '          <link name="value" '
            'target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/'
            'drv/parameters/target/value"/>\n'
            '        </group>\n'
            '        <group name="T" type="NXsensor">\n'
            '          <field name="name" type="NX_CHAR">T'
            '<strategy mode="INIT"/></field>\n'
            '          <field name="measurement" type="NX_CHAR">temperature'
            '<strategy mode="INIT"/><attribute name="secop_importance" '
            'type="NX_INT32">40</attribute>'
            '<attribute name="secop_function" type="NX_CHAR">'
            'temperature</attribute></field>\n'
            '          <field name="model" type="NX_CHAR">'
            ...
            '      <field name="type" type="NX_CHAR">sample environment'
            '<strategy mode="INIT"/></field>\n'
            '      <group name="{cpname}" type="NXenvironment">\n'
            '        <field name="name" type="NX_CHAR">uniax_sim.psi.ch'
            '<strategy mode="INIT"/></field>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_status_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_target_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__limit_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            ...
            '<strategy mode="INIT"/></field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__slope_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__force_offset_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__hysteresis_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '              <field name="maximal_value" type="NX_FLOAT64" '
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__safe_current_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '              <field name="maximal_value" type="NX_FLOAT64" '
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__low_pos_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '<strategy mode="INIT"/></field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__high_pos_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '            <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '          </group>\n'
            ...
            'sample_environment/{cpname}/force/parameters/target/value"/>\n'
            '        </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_transducer_status_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_transducer__jitter_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_transducer__offset_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '            </group>\n'
            ...
            '</field>\n'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_res_pollinterval_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>\n'
            '              <field name="minimal_value" type="NX_FLOAT64">'
        ...
        self.myuni2 = ('<?xml version=\'1.0\' encoding=\'utf8\'?>\n'
                       '<definition>\n'
                       ...
                       '          <field name="measurement" type="NX_CHAR">temperature<strategy mode="INIT"/><attribute name="secop_importance" type="NX_INT32">40</attribute><attribute name="secop_key" type="NX_CHAR">sample temperature</attribute><attribute name="secop_link" type="NX_CHAR">http://purl.allotrope.org/ontologies/result#AFR_0002149</attribute><attribute name="secop_function" type="NX_CHAR">temperature_regulation</attribute></field>\n'
                       ...
                       '      </group>\n'
                       '      <group name="temperature_env" type="NXenvironment">\n'
                       '        <link name="T" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/T"/>\n'
                       '        <link name="description" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/description"/>\n'
                       '        <link name="name" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/name"/>\n'
                       '        <link name="short_name" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/short_name"/>\n'
                       '        <link name="type" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/type"/>\n'
                       '      </group>\n'
                       '      <link name="temperature" target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}/T/value_log"/>\n'
                       '      <group name="transformations" type="NXtransformations">\n'
                       '        <link name="{cpname}_drv" target="/$var.entryname#\'scan\'$var.serialno/sample_environment/{cpname}/drv/value_log/value"/>\n'
                       '      </group>\n'
                       '    </group>\n'
                       '    <group name="sample_environment" type="NXsample">\n'
                       ...
                       '          <field name="measurement" type="NX_CHAR"><strategy mode="INIT"/><attribute name="secop_importance" type="NX_INT32">40</attribute><attribute name="secop_key" type="NX_CHAR">force</attribute><attribute name="secop_link" type="NX_CHAR">http://purl.allotrope.org/ontologies/result#AFR_0001</attribute><attribute name="secop_function" type="NX_CHAR">force</attribute></field>\n'
                       ...
                       '              <field name="minimal_value" type="NX_FLOAT64">0.1<strategy mode="INIT"/></field>\n'
                       '              <field name="maximal_value" type="NX_FLOAT64">120<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="target" type="NXlog">\n'
                       ...
                       '              <field name="maximal_value" type="NX_FLOAT64" units="N">150<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="_tolerance" type="NXlog">\n'
                       ...
                       '              <field name="maximal_value" type="NX_FLOAT64" units="N">10<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="_slope" type="NXlog">\n'
                       ...
                       '              <field name="maximal_value" type="NX_FLOAT64" units="s">60<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="_current_step" type="NXlog">\n'
                       ...
                       '              <field name="maximal_value" type="NX_FLOAT64" units="A">2.8<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="_safe_step" type="NXlog">\n'
                       ...
                       '          <field name="measurement" type="NX_CHAR"><strategy mode="INIT"/><attribute name="secop_importance" type="NX_INT32">40</attribute><attribute name="secop_key" type="NX_CHAR">rotation_z</attribute><attribute name="secop_link" type="NX_CHAR">http://purl.allotrope.org/ontologies/result#AFR_0002</attribute><attribute name="secop_function" type="NX_CHAR">rotation_z</attribute></field>\n'
                       ...
                       '              <field name="maximal_value" type="NX_FLOAT64">1<strategy mode="INIT"/></field>\n'
                       '            </group>\n'
                       '            <group name="_speed" type="NXlog">\n'
                       ...
                       '          </group>\n'
                       '          <link name="value" target="/$var.entryname#\'scan\'$var.serialno/sample_environment/{cpname}/drv/parameters/target/value"/>\n'
                       '        </group>\n'
                       '        <group name="transducer" type="NXsensor">\n'
                       '          <field name="name" type="NX_CHAR">transducer<strategy mode="INIT"/></field>\n'
                       '          <field name="measurement" type="NX_CHAR"><strategy mode="INIT"/><attribute name="secop_importance" type="NX_INT32">42</attribute><attribute name="secop_key" type="NX_CHAR">force</attribute><attribute name="secop_link" type="NX_CHAR">http://purl.allotrope.org/ontologies/result#AFR_0003</attribute><attribute name="secop_function" type="NX_CHAR">force</attribute></field>\n'
                       ...
                       '          <field name="measurement" type="NX_CHAR">resistance<strategy mode="INIT"/><attribute name="secop_importance" type="NX_INT32">40</attribute><attribute name="secop_key" type="NX_CHAR">resistance</attribute><attribute name="secop_link" type="NX_CHAR">http://purl.allotrope.org/ontologies/result#AFR_0006</attribute><attribute name="secop_function" type="NX_CHAR">resistance</attribute></field>\n'
        ...
        self.myunidy = (
            ...
            '        </group>\n'
            '      </group>\n'
            '      <attribute name="secop_env_links" type="NX_CHAR">'
            '$datasources.sample_env_links<strategy mode="FINAL"/>'
            '</attribute>\n'
            ...
            '$datasources.sample_nxdata<strategy mode="FINAL"/></attribute>'
            '      <group name="transformations" type="NXtransformations">\n'
            '        <link name="{cpname}_drv" '
            'target="/$var.entryname#\'scan\'$var.serialno/sample/{cpname}'
            '/drv/value_log/value"/>\n'
            ...
            '        </group>\n'
            '      </group>\n'
            '      <attribute name="sampleenv_nxdata" type="NX_CHAR">'
            '$datasources.sampleenv_nxdata<strategy mode="FINAL"/>'
            '</attribute>\n'
            '    </group>\n'
            '  </group>\n'
            '</definition>\n')
