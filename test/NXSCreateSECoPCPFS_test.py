...
class NXSCreateSECoPCPFSTest(unittest.TestCase):
    ...
    def __init__(self, methodName):
        ...
        self.myuni = (
            ...
            'type="NX_INT32">40</attribute></field>\n'
            '          <field name="model" type="NX_CHAR">'
        ...
        self.myuni2 = (
            ...
            'type="NXentry">'
            '    <group name="sample" type="NXsample">'
            '      <field name="type" type="NX_CHAR">sample<strategy '
            'mode="INIT"/></field>'
            '      <group name="{cpname}" type="NXenvironment">'
            '        <field name="name" type="NX_CHAR">uniax_sim.psi.ch'
            '<strategy mode="INIT"/></field>'
            ...
            'The Python Framework for SECoP (2021.02)<strategy mode="INIT"/>'
            '</field>'
            '        <field name="description" type="NX_CHAR">[sim] uniaxial '
            'pressure device<strategy mode="INIT"/></field>'
            '        <group name="T" type="NXsensor">'
            '          <field name="name" type="NX_CHAR">T<strategy '
            'mode="INIT"/></field>'
            '          <field name="model" type="NX_CHAR">'
            'secop_psi.softcal.Sensor<strategy mode="INIT"/></field>'
            '          <field name="description" type="NX_CHAR">'
            ...
            '            <group name="status" type="NXlog">'
            '              <field name="value" type="NX_INT64">'
            '$datasources.{cpname}_force_status<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_status_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            ...
            '            <group name="target" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64" units="N">'
            '$datasources.{cpname}_force_target<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_target_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            ...
            '            <group name="_limit" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64" units="N">'
            '$datasources.{cpname}_force__limit<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__tolerance_time<attribute '
            ...
            '            <group name="_slope" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64" '
            'units="deg/N">$datasources.{cpname}_force__slope<strategy '
            'mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__slope_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '            </group>'
            '            <group name="_pid_i" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64">'
            '$datasources.{cpname}_force__pid_i<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__pid_i_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time<strategy '
            'mode="INIT"/></attribute><strategy mode="INIT"/></field>'
            '            </group>'
            '            <group name="_filter_interval" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__filter_interval<strategy '
            'mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__filter_interval_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '              <field name="maximal_value" type="NX_FLOAT64" '
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__current_step_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '            </group>'
            ...
            '            <group name="_adjusting_current" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64" units="A">'
            '$datasources.{cpname}_force__adjusting_current<strategy '
            'mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__adjusting_current_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '              <field name="maximal_value" type="NX_FLOAT64" '
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__safe_step_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '            </group>'
            ...
            '          </group>'
            '          <link name="value" '
            'target="/$var.entryname#\'scan\'$var.serialno/sample_environment/'
            '{cpname}/force/parameters/target/value"/>'
            '        </group>'
            '        <group name="drv" type="NXsensor">'
            '          <field name="name" type="NX_CHAR">drv<strategy '
            'mode="INIT"/></field>'
            '          <field name="model" type="NX_CHAR">'
            'secop.simulation.SimBase_drv<strategy mode="INIT"/></field>'
            '          <field name="description" type="NX_CHAR">'
            ...
            '$datasources.{cpname}_drv_status<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv_status_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time<strategy '
            'mode="INIT"/></attribute><strategy mode="INIT"/></field>'
            '            </group>'
            '            <group name="pollinterval" type="NXlog">'
            ...
            '            <group name="_speed" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64">'
            '$datasources.{cpname}_drv__speed<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv__tolerance_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time<strategy '
            'mode="INIT"/></attribute><strategy mode="INIT"/></field>'
            '            </group>'
            '          </group>'
            '          <group name="value_log" type="NXlog">'
            '            <field name="value" type="NX_FLOAT64" units="deg">'
            '$datasources.{cpname}_drv<strategy mode="INIT"/></field>'
            '            <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_drv_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            ...
            '            <group name="_jitter" type="NXlog">'
            '              <field name="value" type="NX_FLOAT64">'
            '$datasources.{cpname}_res__jitter<strategy mode="INIT"/></field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_res__jitter_time<attribute name="start" '
            'type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>'
            '            </group>'
        ...
        self.myunidy2 = (
            ...
            '      </group>'
            '      <attribute name="secop_env_links" type="NX_CHAR">'
            '$datasources.sample_env_links<strategy mode="FINAL"/></attribute>'
            '      <attribute name="secop_log_links" type="NX_CHAR">'
            '$datasources.sample_log_links<strategy mode="FINAL"/></attribute>'
            '      <attribute name="sample_nxdata" type="NX_CHAR">'
            '$datasources.sample_nxdata<strategy mode="FINAL"/></attribute>'
            '    </group>'
            '    <group name="sample_environment" type="NXsample">'
            ...
            'pressure device<strategy mode="INIT"/></field>'
            '        <group name="force" type="NXsensor">'
            '          <field name="name" type="NX_CHAR">force<strategy '
            'mode="INIT"/></field>'
            '          <field name="model" type="NX_CHAR">'
            'secop_psi.uniax.Uniax<strategy mode="INIT"/></field>'
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force_pollinterval_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '              <field name="minimal_value" type="NX_FLOAT64">0.1'
            ...
            '</field>'
            '              <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_force__adjusting_time<attribute '
            'name="start" type="NX_DATE_TIME">$datasources.client_start_time'
            '<strategy mode="INIT"/></attribute><strategy mode="INIT"/>'
            '</field>'
            '            </group>'
            ...
            '          <link name="value" '
            'target="/$var.entryname#\'scan\'$var.serialno/'
            'sample_environment/{cpname}/drv/parameters/target/value"/>'
            '        </group>'
            '        <group name="transducer" type="NXsensor">'
            '          <field name="name" type="NX_CHAR">transducer'
            '<strategy mode="INIT"/></field>'
            ...
            'units="s">$datasources.{cpname}_transducer_pollinterval_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>'
            '              <field name="minimal_value" type="NX_FLOAT64">0.1'
            ...
            '$datasources.{cpname}_transducer<strategy mode="INIT"/></field>'
            '            <field name="time" type="NX_FLOAT64" units="s">'
            '$datasources.{cpname}_transducer_time'
            '<attribute name="start" type="NX_DATE_TIME">'
            '$datasources.client_start_time<strategy mode="INIT"/>'
            '</attribute><strategy mode="INIT"/></field>'
            '          </group>'
