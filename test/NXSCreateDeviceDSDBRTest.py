...
try:
    ...
    from . import NXSCreateDeviceDSDBTest
...
class NXSCreateDeviceDSDBRTest(
        NXSCreateDeviceDSDBTest.NXSCreateDeviceDSDBTest):
    ...
    def setUp(self):
        self._sv2.setUp()
        NXSCreateDeviceDSDBTest.NXSCreateDeviceDSDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateDeviceDSDBTest.NXSCreateDeviceDSDBTest.tearDown(self)
        self._sv2.tearDown()
