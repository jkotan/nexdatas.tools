...
try:
    ...
    from . import NXSCreateTangoDSFSTest
...
# test fixture
class NXSCreateTangoDSDBTest(
        NXSCreateTangoDSFSTest.NXSCreateTangoDSFSTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateTangoDSFSTest.NXSCreateTangoDSFSTest.__init__(
            self, methodName)
    ...
    # \brief Common set up
    def setUp(self):
        NXSCreateTangoDSFSTest.NXSCreateTangoDSFSTest.setUp(self)
        self._sv.setUp()
        self.openConf()
    ...
    def tearDown(self):
        NXSCreateTangoDSFSTest.NXSCreateTangoDSFSTest.tearDown(self)
        self.closeConfig()
        self._sv.tearDown()
