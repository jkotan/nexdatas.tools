...
try:
    ...
    from . import NXSCreatePoolDSDBTest
...
# test fixture
class NXSCreatePoolDSDBRTest(
        NXSCreatePoolDSDBTest.NXSCreatePoolDSDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreatePoolDSDBTest.NXSCreatePoolDSDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        self.openConf2()
        NXSCreatePoolDSDBTest.NXSCreatePoolDSDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreatePoolDSDBTest.NXSCreatePoolDSDBTest.tearDown(self)
        self.closeConfig2()
        self._sv2.tearDown()
