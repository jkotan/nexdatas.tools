...
try:
    ...
    from . import NXSCreateOnlineCPFSTest
...
# test fixture
class NXSCreateOnlineCPDBTest(
        NXSCreateOnlineCPFSTest.NXSCreateOnlineCPFSTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateOnlineCPFSTest.NXSCreateOnlineCPFSTest.__init__(
            self, methodName)
    ...
    # \brief Common set up
    def setUp(self):
        NXSCreateOnlineCPFSTest.NXSCreateOnlineCPFSTest.setUp(self)
        self._sv.setUp()
        self.openConf()
    ...
    def tearDown(self):
        NXSCreateOnlineCPFSTest.NXSCreateOnlineCPFSTest.tearDown(self)
        self.closeConfig()
        self._sv.tearDown()
