...
try:
    ...
    from . import NXSCreateOnlineCPDBTest
...
# test fixture
class NXSCreateOnlineCPDBRTest(
        NXSCreateOnlineCPDBTest.NXSCreateOnlineCPDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateOnlineCPDBTest.NXSCreateOnlineCPDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        self.openConf2()
        NXSCreateOnlineCPDBTest.NXSCreateOnlineCPDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateOnlineCPDBTest.NXSCreateOnlineCPDBTest.tearDown(self)
        self.closeConfig2()
        self._sv2.tearDown()
