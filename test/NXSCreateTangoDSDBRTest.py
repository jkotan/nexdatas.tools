...
try:
    ...
    from . import NXSCreateTangoDSDBTest
...
class NXSCreateTangoDSDBRTest(
        NXSCreateTangoDSDBTest.NXSCreateTangoDSDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateTangoDSDBTest.NXSCreateTangoDSDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        NXSCreateTangoDSDBTest.NXSCreateTangoDSDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateTangoDSDBTest.NXSCreateTangoDSDBTest.tearDown(self)
        self._sv2.tearDown()
