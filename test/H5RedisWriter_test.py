...
import nxstools.h5rediswriter as H5RedisWriter
...
# test fixture
class H5RedisWriterTest(unittest.TestCase):
    ...
    def test_default_createfile(self):
        ...
        try:
            fl = H5RedisWriter.create_file(self._fname)
            fl.close()
            fl = H5RedisWriter.create_file(self._fname, True)
            fl.close()
            ...
            fl = H5RedisWriter.open_file(self._fname, readonly=True)
            f = fl.root()
            self.assertEqual(5, len(f.attributes))
            # atts = []
            for at in f.attributes:
            ...
            self.myAssertRaise(
                Exception, H5RedisWriter.create_file, self._fname)

            self.myAssertRaise(
                Exception, H5RedisWriter.create_file, self._fname,
                False)

            fl2 = H5RedisWriter.create_file(self._fname, overwrite=True)
            fl2.close()
        finally:
    ...
    def test_default_loadfile(self):
        ...
        try:
            ...
            if not H5RedisWriter.is_image_file_supported():
                self.myAssertRaise(
                    Exception, H5RedisWriter.load_file, buf, self._fname)
            else:
                fl = H5RedisWriter.load_file(buf, self._fname, readonly=True)
                f = fl.root()
                self.assertEqual(5, len(f.attributes))
                self.assertEqual(
    ...
    def test_h5cppfile(self):
        ...
        try:
            ...
            # rt = nxfl.root()
            fl = H5RedisWriter.H5RedisFile(nxfl, self._fname)
            rt = fl.root()
            attrs = rt.attributes
            attrs.create("file_time", "string").write(
                unicode(H5RedisWriter.H5RedisFile.currenttime()))
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cppfile.h5"))
            self.assertTrue(
    ...
    def test_h5cppgroup(self):
        ...
        try:
            ...
            df0 = H5RedisWriter.deflate_filter()
            df1 = H5RedisWriter.data_filter()
            df1.rate = 2
            df2 = H5RedisWriter.data_filter()
            df2.rate = 4
            df2.shuffle = 6
            ...
            self.assertTrue(
                isinstance(attr0, H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(
                isinstance(attr0.h5object, h5cpp._attribute.AttributeManager))
            self.assertTrue(
                isinstance(attr1, H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(
                isinstance(attr1.h5object, h5cpp._attribute.AttributeManager))

            self.assertTrue(
                isinstance(rt, H5RedisWriter.H5RedisGroup))
            ...
            self.assertTrue(
                isinstance(attr, H5RedisWriter.H5RedisAttributeManager))
            self.assertEqual(
                fl.h5object.root().link.path,
                rt.h5object.link.path)
            ...
            self.assertTrue(
                isinstance(entry, H5RedisWriter.H5RedisGroup))
            ...
            self.assertTrue(
                isinstance(nt, H5RedisWriter.H5RedisGroup))
            ...
            self.assertTrue(
                isinstance(ins, H5RedisWriter.H5RedisGroup))
            ...
            self.assertTrue(
                isinstance(ins_lk, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(
                isinstance(det, H5RedisWriter.H5RedisGroup))
            ...
            self.assertTrue(isinstance(strscalar, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(intscalar, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(strspec, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(floatspec, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(intspec, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(strimage, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(floatimage, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(intimage, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(strvec, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(floatvec, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(intvec, H5RedisWriter.H5RedisField))
            ...
            self.assertTrue(isinstance(strspec_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(intspec_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(floatimage_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(strvec_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(intvec_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(lkintimage, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(isinstance(lkfloatvec, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(isinstance(lkintspec, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(isinstance(lkdet, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(isinstance(lkno, H5RedisWriter.H5RedisLink))
            ...
            self.assertTrue(
                isinstance(lkintspec_op, H5RedisWriter.H5RedisField))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(lkno_op, H5RedisWriter.H5RedisLink))
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cppgroup.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppfield_scalar(self):
        ...
        try:
            ...
            self.assertTrue(
                isinstance(attrs, H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cppfield_scalar.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppfield_image(self):
        ...
        try:
            ...
            df0 = H5RedisWriter.data_filter(name="deflate")
            df1 = H5RedisWriter.data_filter()
            df1.rate = 2
            df2 = H5RedisWriter.data_filter()
            df2.rate = 4
            ...
            self.assertTrue(
                isinstance(floatimage, H5RedisWriter.H5RedisField))
            self.assertTrue(
                isinstance(floatimage.h5object, h5cpp._node.Dataset))
            self.assertEqual(floatimage.name, 'floatimage')
            self.assertEqual(
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cppfield_image.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppfield_vec(self):
        ...
        try:
            ...
            self.assertTrue(isinstance(
                attrs, H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(isinstance(
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cppfield_vec.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppdeflate_list(self):
        ...
        try:
            ...
            df1.rate = 2
            df2 = None
            dfa = H5RedisWriter.data_filter()
            dfa.name = 'deflate'
            dfa.options = (3,)
            dfb = H5RedisWriter.data_filter()
            dfb.name = 'shuffle'
            df2 = [dfa, dfb]
    ...
    def test_h5cppdeflate_const(self):
        ...
        try:
            ...
            df0 = H5RedisWriter.H5RedisDeflate(h5cpp.filter.Deflate())
            df1 = H5RedisWriter.H5RedisDeflate(h5cpp.filter.Deflate())
            df1.rate = 2
            df2 = H5RedisWriter.H5RedisDeflate(h5cpp.filter.Deflate())
            df2.rate = 4
            df2.shuffle = True
    ...
    def test_h5cpplink(self):
        ...
        try:
            ...
            lkintimage = H5RedisWriter.H5RedisLink(lk, dt)
            h5cpp.node.link(
            ...
            lkdet = H5RedisWriter.H5RedisLink(lk, dt)
            h5cpp.node.link(
            ...
            lkno = H5RedisWriter.H5RedisLink(lk, dt)
            lk = None
            ...
            self.assertEqual(fl.path,
                             "%s/%s" % (
                                 os.getcwd(),
                                 "H5RedisWriterTesttest_h5cpplink.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppattributemanager(self):
        ...
        try:
            ...
            self.assertTrue(
                isinstance(attr1.h5object, h5cpp._attribute.AttributeManager))
            self.assertTrue(
                isinstance(attr2, H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(atintscalar, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(atfloatspec, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(atstrscalar, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(atfloatimage, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(
            ...
            self.assertTrue(
                isinstance(atfloatscalar, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(
            ...
            self.assertTrue(isinstance(
                atfloatimage, H5RedisWriter.H5RedisAttribute))
            self.assertTrue(isinstance(
            ...
            self.assertEqual(
                ...
                "%s/%s" % (
                    os.getcwd(),
                    "H5RedisWriterTesttest_h5cppattributemanager.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
...
#               atfloatscalar.h5object.dataspace.current_dimensions, (1,))
            ...
            self.assertEqual(
                ...
                "%s/%s" % (
                    os.getcwd(),
                    "H5RedisWriterTesttest_h5cppattribute_scalar.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
...
#            self.assertEqual(5, len(f.attributes))
    ...
    def test_h5cppattribute_spectrum(self):
        ...
        try:
            ...
            self.assertTrue(
                isinstance(attr2,
                           H5RedisWriter.H5RedisAttributeManager))
            self.assertTrue(
                isinstance(attr2.h5object, h5cpp._attribute.AttributeManager))
            ...
            self.assertEqual(
                ...
                "%s/%s" % (
                    os.getcwd(),
                    "H5RedisWriterTesttest_h5cppattribute_spectrum.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
    ...
    def test_h5cppattribute_image(self):
        ...
        try:
            ...
            self.assertEqual(
                ...
                "%s/%s" % (
                    os.getcwd(),
                    "H5RedisWriterTesttest_h5cppattribute_image.h5"))
            self.assertTrue(
                isinstance(fl.h5object, h5cpp._file.File))
            self.assertEqual(fl.parent, None)
            self.assertEqual(fl.readonly, False)
...
#            self.assertEqual(5, len(f.attributes))
    ...
    def test_h5cpp_vitualfield_image_concatinate(self):
        fun = sys._getframe().f_code.co_name
        print("Run: %s.%s() " % (self.__class__.__name__, fun))
        if not H5RedisWriter.is_vds_supported():
        ...
        try:
            ...
            fl = H5RedisWriter.create_file(fname1, overwrite=True)
            rt = fl.root()
            ...
            fl = H5RedisWriter.create_file(fname2, overwrite=True)
            rt = fl.root()
            ...
            fl = H5RedisWriter.create_file(fname3, overwrite=True)
            rt = fl.root()
            ...
            fl = H5RedisWriter.create_file(self._fname, overwrite=True)
            rt = fl.root()
            entry = rt.create_group("entry123", "NXentry")
            dt = entry.create_group("data", "NXdata")

            ef1 = H5RedisWriter.target_field_view(
                fname1, "/entry1/data/data", [10, 10, 20], "uint32")
            ef2 = H5RedisWriter.target_field_view(
                fname2, "/entry2/data/data", [10, 10, 20], "uint32")
            ef3 = H5RedisWriter.target_field_view(
                fname3, "/entry3/data/data", [10, 10, 20], "uint32")

            vfl = H5RedisWriter.virtual_field_layout([30, 10, 20], "uint32")
            vfl[0:10, :, :] = ef1
            vfl[10:20, :, :] = ef2
            vfl[20:30, :, :] = ef3
    ...
    def test_h5cpp_vitualfield_image_gap(self):
        ...
        if not H5RedisWriter.is_vds_supported():
            self.myAssertRaise(
                Exception, H5RedisWriter.virtual_field_layout, [100])
            print("Skip the test: VDS not supported")
            return
        self._fname = '%s/%s%s.h5' % (
            os.getcwd(), self.__class__.__name__, fun)
        ...
        try:
            ...
            vfl = H5RedisWriter.virtual_field_layout([30, 10, 20], "int16")
            vfl[0:10, :, :] = ef1
            vfl[20:30, :, :] = ef3
    ...
    def test_h5cpp_vitualfield_image_unlimited(self):
        ...
        try:
            ...
            fl1 = H5RedisWriter.create_file(fname1, overwrite=True)
            rt1 = fl1.root()
            ...
            vfl = H5RedisWriter.virtual_field_layout([10, 10, 20], "int16")
            vfl.add(
                (slice(None, H5RedisWriter.unlimited()),
