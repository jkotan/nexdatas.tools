...
try:
    ...
    from . import NXSCreateCompDBTest
...
class NXSCreateCompDBRTest(
        NXSCreateCompDBTest.NXSCreateCompDBTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateCompDBTest.NXSCreateCompDBTest.__init__(
            self, methodName)
    ...
    def setUp(self):
        self._sv2.setUp()
        NXSCreateCompDBTest.NXSCreateCompDBTest.setUp(self)

    # test closer
    # \brief Common tear down
    def tearDown(self):
        NXSCreateCompDBTest.NXSCreateCompDBTest.tearDown(self)
        self._sv2.tearDown()
