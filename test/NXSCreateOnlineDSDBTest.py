...
try:
    ...
    from . import NXSCreateOnlineDSFSTest
...
# test fixture
class NXSCreateOnlineDSDBTest(
        NXSCreateOnlineDSFSTest.NXSCreateOnlineDSFSTest):

    # constructor
    # \param methodName name of the test method
    def __init__(self, methodName):
        NXSCreateOnlineDSFSTest.NXSCreateOnlineDSFSTest.__init__(
            self, methodName)
    ...
    # \brief Common set up
    def setUp(self):
        NXSCreateOnlineDSFSTest.NXSCreateOnlineDSFSTest.setUp(self)
        self._sv.setUp()
        self.openConf()
    ...
    def tearDown(self):
        NXSCreateOnlineDSFSTest.NXSCreateOnlineDSFSTest.tearDown(self)
        self.closeConfig()
        self._sv.tearDown()
